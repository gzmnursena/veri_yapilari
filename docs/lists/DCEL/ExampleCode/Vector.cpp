...
Vector::Vector() : x(0), y(0), z(0) //constructor
{
}

Vector::Vector(double newX, double newY, double newZ) : x(newX), y(newY), z(newZ) //constructor
{
}

Vector::Vector(double array[]) : x(array[0]), y(array[1]), z(array[2]) //constructor
{
}

Vector::Vector(float array[]) : x(array[0]), y(array[1]), z(array[2]) //constructor
{
}

Vector::Vector(int array[]) : x(array[0]), y(array[1]), z(array[2]) //constructor
{
}
...
{
    //Formül CW'yi eksen etrafında döndürür. CCW rotasyonları açısından düşünmeyi, diğer rotasyon yöntemlerine uymayı tercih edin
